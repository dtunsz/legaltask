  ...
  <div>
    ...
    <table>
      ...
      <tr v-for="(log, index) in formattedLogs" :key="log.identifier">
        ...
        <td>{{ log.callCount }} {{ log.callCount > 1 ? "calls" : "call" }}</td>
        <td>
...
export default {
    ...
    return {
      agents: [
        ...
        },
        {
          ...
          photo:
            "https://via.placeholder.com/300/E241BC/FFFFFF?text=Rose.Patterson",
        },
        {
          ...
          photo:
            "https://via.placeholder.com/300/E241BC/FFFFFF?text=Joel.Wagner",
        },
        {
          ...
          photo:
            "https://via.placeholder.com/300/E241BC/FFFFFF?text=Wilfred.Anderson",
        },
        {
          ...
          photo:
            "https://via.placeholder.com/300/E241BC/FFFFFF?text=Delbert.Pena",
        },
        {
          ...
          photo:
            "https://via.placeholder.com/300/E241BC/FFFFFF?text=Madeline.Lee",
        },
        {
        ...
        },
        {
          ...
          photo:
            "https://via.placeholder.com/300/E241BC/FFFFFF?text=Albert.Roy",
        },
      ],
      logs: [
        {
  ...
  computed: {
    formattedLogss() {
      ...
      //       for (let index = this.agents.length; index--) {
      //         //   const element = array[index];
      //           if (this.agents[index].identifier == log.agentIdentifier) {
      //             all.push(log)
      //           }

      //       }
      //     //   if (this.agents.map((agent) => agent.identifier == log.agentIdentifier)) {
      //     //       all.push(log)
      //     //   }
      //   });
      return all;
